const CoffeeData = [
  {
    ...
    imagelink_square: require('../assets/coffee_assets/americano/square/americano_pic_1_square.png'), // we can use https or require we use require because when it bundling it will not locate and throw error thats why we were using this
